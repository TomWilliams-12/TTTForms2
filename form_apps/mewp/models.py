...
class Mewp(models.Model):
    ...
    machineGroup = models.CharField(max_length=30, blank=True, null=True)
    ...
    machineType = models.CharField(max_length=20, blank=True, null=True)
    ...
    machine_Test_Lift_Height = models.CharField(max_length=10, blank=True, null=True)
    machine_Capacity = models.CharField(max_length=10, blank=True, null=True)
    ...
    motivePower = models.CharField(max_length=20, blank=True, null=True)
    ...
    parkBays = models.CharField(max_length=5, blank=True, null=True)
    sideMidLevel = models.CharField(max_length=5, blank=True, null=True)
    ...
    specialApplication = models.CharField(max_length=50, blank=True, null=True)
    preUsePoints = models.CharField(max_length=5, blank=True, null=True)
    ...
    theoryPaperNumber = models.CharField(max_length=10, blank=True, null=True)
