    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('md_9', models.BooleanField()),
                ('md_10', models.BooleanField()),
                ...
                ('preUseEM_30', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('company_Name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='boomCustomer', to='customers.customers')),
                ('course_Number', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='boomCourse', to='courses.courses')),
                ('instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='boomInstructor', to=settings.AUTH_USER_MODEL)),
                ('instructor_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='boomInstructor2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
