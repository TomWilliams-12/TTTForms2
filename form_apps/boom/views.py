...
test = {
    ...
    '10': {'num': '8', 't': False, 'crit': 'Failes to secure turntable', 'pen': '3'},
    '11': {'num': '9', 't': False, 'crit': 'Travels with carrier too high', 'pen': '3'},
    '12': {'num': '10', 't': False, 'crit': 'Travels with carrier too low', 'pen': '3'},
    '13': {'num': '11', 't': False, 'crit': 'Touches Course', 'pen': '3'},
    '14': {'num': '12', 't': False, 'crit': 'Shunts in chicane/bay areas', 'pen': '1*'},
    '15': {'num': '13', 't': False, 'crit': 'Activates wrong direction control', 'pen': '5'},
    '16': {'num': '14', 't': False, 'crit': 'Steers erratically', 'pen': '5'},
    '17': {'num': '15', 't': False, 'crit': 'Brakes harshly/erratically', 'pen': '3'},
    '18': {'num': '16', 't': False, 'crit': 'Erratic change of direction', 'pen': '5'},
    '19': {'num': '17', 't': False, 'crit': 'Travels with axles extended', 'pen': '3'},
    '20': {'num': '103', 't': True, 'crit': 'Lifting Operations', 'pen': '0'},
    '21': {'num': '18', 't': False, 'crit': 'Failts to position equipment accurately', 'pen': '3'},
}
test2 = {
    '1': {'num': '19', 't': False, 'crit': 'Fails to cordon off area', 'pen': '3'},
    '2': {'num': '20', 't': False, 'crit': 'Fails to check stabiliser engagement', 'pen': '5'},
    '3': {'num': '21', 't': False, 'crit': 'Fails to level equipment correctly', 'pen': '5'},
    '4': {'num': '22', 't': False, 'crit': 'Fails to lock stabilisers/axle locks', 'pen': '5'},
    '4': {'num': '23', 't': False, 'crit': 'Fails to use extendable axles', 'pen': '3'},
    '5': {'num': '24', 't': False, 'crit': 'Selects wrong hydraulic control', 'pen': '3'},
    '6': {'num': '25', 't': False, 'crit': 'Rough use of hydraulic controls', 'pen': '3'},
    '7': {'num': '26', 't': False, 'crit': 'Excessive use of hydraulic controls', 'pen': '1*'},
    '8': {'num': '27', 't': False, 'crit': 'Operates too close to hazards', 'pen': '3'},
    '9': {'num': '28', 't': False, 'crit': 'Touches structure', 'pen': '3'},
    '10': {'num': '29', 't': False, 'crit': 'Uses toe-plates/railings to gain height', 'pen': '5'},
    '11': {'num': '30', 't': False, 'crit': 'Fails to check below before lowering', 'pen': '3'},
    '12': {'num': '31', 't': False, 'crit': 'Lifts/lowers in wrong sequence', 'pen': '5'},
    '12': {'num': '32', 't': False, 'crit': 'Fails to re-configfure for travelling', 'pen': '5'},
    '13': {'num': '202', 't': True, 'crit': 'Parking and Shut Down', 'pen': '0'},
    '14': {'num': '33', 't': False, 'crit': 'fails to position correctly', 'pen': '3'},
    '15': {'num': '34', 't': False, 'crit': 'Fails to switch off and isolate', 'pen': '5'},
    '16': {'num': '35', 't': False, 'crit': 'Fails to remove key', 'pen': '3'},
    '17': {'num': '36', 't': False, 'crit': 'Fails to complete post-stop checks', 'pen': '5'},
}
carry_forward = 18
review_choices = (
    ('1','1'),
...
md = [
    ...
    'Ignores overload indicator',
    'works outside lifting envelope',
    'Failts theoretical test (see separate marking/test sheet)',
    'Fails to apply axle locks'
]
checks = [
...
class BoomPage(View):
    def get(self, request):
        ...
        form = BoomForm(initial={'start_Date': datetime.datetime.today(), 'instructor': instructor})
    ...
    def post(self, request):
        boomForm = BoomForm(request.POST)
        if boomForm.is_valid():
            boomForm.save()
            last_form = Boom.objects.last()
            form = Forms(form_type=last_form)
            form.save()
            return redirect('/')


class EditBoom(UpdateView):
    model = Boom
    form_class = BoomForm
    ...
    def get_context_data(self, **kwargs):
        ctx = super(EditBoom, self).get_context_data(**kwargs)
        form = BoomForm(instance=self.object)
