# Generated by Django 3.2.7 on 2022-06-04 11:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mini_Micro', models.CharField(blank=True, max_length=20, null=True)),
                ('tracked_Wheeled', models.CharField(blank=True, max_length=20, null=True)),
                ('manual_Semi', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('hitch_Type', models.CharField(blank=True, max_length=30, null=True)),
                ('attachment', models.CharField(blank=True, max_length=30, null=True)),
                ...
                ('tenching', models.CharField(blank=True, max_length=5, null=True)),
                ('back_Filling', models.CharField(blank=True, max_length=5, null=True)),
                ('stock_Pile', models.CharField(blank=True, max_length=5, null=True)),
                ('sop', models.CharField(blank=True, max_length=5, null=True)),
                ('es', models.CharField(blank=True, max_length=5, null=True)),
                ('vehicle', models.CharField(blank=True, max_length=5, null=True)),
                ('bucket_Change', models.CharField(blank=True, max_length=5, null=True)),
                ('hopper', models.CharField(blank=True, max_length=5, null=True)),
                ...
                ('penalty_39', models.IntegerField(blank=True, null=True)),
                ('penalty_40', models.IntegerField(blank=True, null=True)),
                ('penalty_41', models.IntegerField(blank=True, null=True)),
                ('penalty_42', models.IntegerField(blank=True, null=True)),
                ('penalty_43', models.IntegerField(blank=True, null=True)),
                ('penalty_44', models.IntegerField(blank=True, null=True)),
                ('penalty_45', models.IntegerField(blank=True, null=True)),
                ('penalty_46', models.IntegerField(blank=True, null=True)),
                ...
                ('preUseEM_28', models.CharField(blank=True, max_length=10, null=True)),
                ('preUseEM_29', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('company_Name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='threesixtyCustomer', to='customers.customers')),
                ('course_Number', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='threesixtyCourse', to='courses.courses')),
                ('instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='threesixtyInstructor', to=settings.AUTH_USER_MODEL)),
                ('instructor_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='threesixtyInstructor2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
