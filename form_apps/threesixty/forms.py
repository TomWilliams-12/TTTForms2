...
class ThreeSixtyForm(ModelForm):
    def __init__(self, *args, **kwargs):
        super(ThreeSixtyForm, self).__init__(*args, **kwargs)
    ...
    class Meta:
        ...
        labels = {
            ...
            'mini_Micro': 'mini/Micro/medium/heavy',
            'tracked_Wheeled': 'Tracked/Wheeled',
            'machine_Make_Model': 'Make/Model',
            'manual_Semi': 'Manual/semi-auto/fully-auto hitch',
            'testPass': 'Pass',
            ...
            'penalty_39': 'penalty_39',
            'penalty_40': 'penalty_40',
            'penalty_41': 'penalty_41',
            'penalty_42': 'penalty_42',
            'penalty_43': 'penalty_43',
            'penalty_44': 'penalty_44',
            'penalty_45': 'penalty_45',
            'penalty_46': 'penalty_46',
            'md_1': 'md_1',
            'md_2': 'md_2',
            'md_3': 'md_3',
            'md_4': 'md_4',
        ...
        widgets = {
            ...
            'mini_Micro': forms.Select(choices=(('',''), ('Mini','Mini'), ('Micro','Micro'), ('Medium','Mediun'), ('Heavy','Heavy'))),
            'tracked_Wheeled': forms.Select(choices=(('',''), ('Tracked','Tracked'), ('Wheeled','Wheeled'))),
            'manual_Semi': forms.Select(choices=(('',''), ('Manual','Manual'), ('Semi-Auto','Semi-Auto'), ('Fully-Auto','Fully-Auto'))),
            ...
            'penalty_39': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_40': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_41': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_42': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_43': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_44': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_45': widgets.NumberInput(attrs={'class': 'award'}),
            'penalty_46': widgets.NumberInput(attrs={'class': 'award'}),
