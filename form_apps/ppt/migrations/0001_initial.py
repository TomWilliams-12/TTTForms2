    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machineGroup', models.CharField(blank=True, max_length=50, null=True)),
                ('machineCapacity', models.CharField(blank=True, max_length=50, null=True)),
                ('loadCentre', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('topsId', models.CharField(blank=True, max_length=20, null=True)),
                ('courseTitle', models.CharField(blank=True, max_length=50, null=True)),
                ('courseDuration', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('machineMotivePower', models.CharField(blank=True, max_length=20, null=True)),
                ('riderPedestrian', models.CharField(blank=True, max_length=15, null=True)),
                ('attachments2', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('lowLevel', models.CharField(blank=True, max_length=5, null=True)),
                ('eyeLevel', models.CharField(blank=True, max_length=5, null=True)),
                ('highLevel', models.CharField(blank=True, max_length=5, null=True)),
                ('vertFace', models.CharField(blank=True, max_length=5, null=True)),
                ('sop', models.CharField(blank=True, max_length=5, null=True)),
                ('fts', models.CharField(blank=True, max_length=5, null=True)),
                ('vehicleLoading', models.CharField(blank=True, max_length=5, null=True)),
                ('ramps', models.CharField(blank=True, max_length=5, null=True)),
                ('attachmentsInitial', models.CharField(blank=True, max_length=5, null=True)),
                ('specialApplication', models.CharField(blank=True, max_length=5, null=True)),
                ...
                ('machineMakeModel', models.CharField(blank=True, max_length=30, null=True)),
                ('e_abaCategory', models.CharField(blank=True, max_length=30, null=True)),
                ('e_motivePower', models.CharField(blank=True, max_length=30, null=True)),
                ...
                ('company_Name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pptCustomer', to='customers.customers')),
                ('course_Number', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pptCourse', to='courses.courses')),
                ('instructor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pptInstructor', to=settings.AUTH_USER_MODEL)),
                ('instructor_2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pptInstructor2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
