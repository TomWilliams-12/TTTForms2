...
class PptForm(ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'mewpS': '** MEWP.S',
            'fts': '** F.T.S',
            'attachments_Initial': 'Attachments',
        ...
        riderPed = [('',''), ('Rider', 'Rider'), ('Pedestrian', 'Pedestrian')]
        widgets = {
            ...
            'platformY': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'platformN': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            ...
            'machine_Make': forms.TextInput(),
            'machine_Model': forms.TextInput(attrs={'class':'truckModel', 'onchange': 'updateModel()'}),
            'machine_Type': forms.TextInput(attrs={'class':'truckType', 'onchange': 'updateTruck()'}),
            'machine_Group': forms.Select(choices=group, attrs={'class':'group', 'onchange': 'updateGroup()'}),
            'attachments': forms.TextInput(attrs = {'class':'attachments', 'onchange' : "updateAttachments();"}),
            'machine_Motive_Power': forms.Select(choices=motive_power, attrs={'class': 'motive', 'onchange': 'motiveAutofill()'}),
            'test_Pass': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'test_Fail': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'test_Date': widgets.DateInput(attrs={'type': 'date'}),
            'preUsePass': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'preUseFail': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'preUseDate': widgets.DateInput(attrs={'type': 'date'}),
            'akPass': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'akFail': widgets.CheckboxInput(attrs={'style':'width:20px;height:20px;float:none;'}),
            'akDate': widgets.DateInput(attrs={'type': 'date'}),
            ...
            'rider_Pedestrian': forms.Select(choices=riderPed),
            ...
            'preUseEM_24': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_25': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_26': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_27': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_28': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_29': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_30': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
            'preUseEM_31': widgets.CheckboxInput(attrs={'style':'width:30px;height:30px;float:none;'}),
