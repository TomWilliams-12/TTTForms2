...
class Ppt(models.Model):
    ...
    course_Number = models.ForeignKey(Courses, related_name='pptCourse', on_delete=models.SET_NULL, null=True, blank=True)
    venue = models.CharField(max_length=30, blank=True, null=True)
    start_Date = models.DateField(blank=True, null=True)
    finish_Date = models.DateField(blank=True, null=True)
    instructor = models.ForeignKey(Profile, related_name='pptInstructor', on_delete=models.SET_NULL, null=True, blank=True)
    ...
    load_Centre = models.IntegerField(blank=True, null=True)
    ...
    instructor_2 = models.ForeignKey(Profile, related_name='pptInstructor2', on_delete=models.SET_NULL, null=True, blank=True)
