...
function updateGroup(){
    ...
    let groupFill = document.querySelectorAll('.groupFill');
    for (let i = 0; i < groupFill.length; i++) {
        groupFill[i].value = group;
    }
}
function updateAttachments(){
    let attachments = document.querySelector('.attachments').value;
    let attachmentsFill = document.querySelectorAll('.attachmentsFill');
    for (let i = 0; i < attachmentsFill.length; i++) {
        attachmentsFill[i].value = attachments;
    }
}
